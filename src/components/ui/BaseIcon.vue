...
const iconPaths: Record<string, any> = {
  ...
  flask: defineComponent({
    render: () => [
      h('path', { d: 'M10 2v7.31' }),
      h('path', { d: 'M14 9.3V1.99' }),
      h('path', { d: 'M8.5 2h7' }),
  ...
  check: defineComponent({
    render: () => [h('polyline', { points: '20 6 9 17 4 12' })],
  }),
  plus: defineComponent({
    render: () => [h('path', { d: 'M12 5v14M5 12h14' })],
  }),
  ...
  play: defineComponent({
    render: () => [h('polygon', { points: '5 3 19 12 5 21 5 3' })],
  }),
  'fast-forward': defineComponent({
    render: () => [
      h('polygon', { points: '13 19 22 12 13 5 13 19' }),
      h('polygon', { points: '2 19 11 12 2 5 2 19' }),
    ],
  }),
  bell: defineComponent({
    render: () => [
