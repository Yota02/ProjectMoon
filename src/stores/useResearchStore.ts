...
function createInitialResearches() {
  const researches: Record<string, ResearchNode> = {
    ...
    'i-robotics': {
      ...
      description: 'Maintenance et opérations autonomes par des drones de haute précision.',
      category: 'Informatique',
      cost: 800,
      duration: 200,
      progress: 0,
    ...
    'c-helium3': {
      id: 'c-helium3',
      name: "Extraction d'Hélium-3",
      description: 'Extraction du combustible ultime pour la fusion nucléaire sur le sol lunaire.',
      category: 'Colonisation',
      cost: 2500,
      duration: 600,
      progress: 0,
      status: isDebugMode ? 'completed' : 'locked',
      prerequisites: ['i-robotics', 'h-cryo', 'c-mine'],
      tier: 4,
    },
    'c-terraforming': {
      id: 'c-terraforming',
